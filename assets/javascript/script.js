...
.to("#logoSection", { autoAlpha: 0, ease: "power3.out", y:0, }, .3) // fade out logo section
.to("#logoSection img", { width: "400px",height: "400px", ease: "power3.out" }, 0); // animate logo width reduction
...
if(window.innerWidth < 700) {
  ...
  .to("#logoSection", { autoAlpha: 0, ease: "power3.out", y:0, }, .3) // fade out logo section
  .to("#logoSection img", { width: "250px",height: "250px", ease: "power3.out" }, .3); // animate logo width reduction 
}
